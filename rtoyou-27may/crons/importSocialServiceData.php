...
$handle = fopen("RTO-SOCIALSEVICES.csv","r");
$count = 0;
...
while (($fields = fgetcsv($handle, 0, ",")) !== FALSE) {
	...
	$r = explode('<br/>', wordwrap($review, 80, "<br/>", true));
      //  $r = wordwrap($review, 70, "\n", true);
        ...
        $reviews[]=array('comment'=>$review,'comment_from'=>$allUsersDb[$user]['user_id'],'cat_id'=>$company,'rating'=>$rating,'status'=>1,'comment_time'=>date('Y-m-d H:i:s'),'comment_title'=>$r[0]);
    }
